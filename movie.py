class MyMovie():
    ...
    This is the main MyMovie class that stores  the details of the movie.
    It stores the movie titles, movie story line, movie poster URL, and
    movie trailer URL.
    ...
    def __init__(self,
        ...
        Attributes:
            ...
            movie_trailer_url (str): The URL of the movie's YouTube trailer.
        """
